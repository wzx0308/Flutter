...
class RegisterPage extends GetView<RegisterController> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  Text('app_name'.tr, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w300, color: Colors.white, letterSpacing: 8)),
                  const SizedBox(height: 8),
                  Text('register_subtitle'.tr, style: TextStyle(fontSize: 13, color: Colors.white.withOpacity(0.6), letterSpacing: 1)),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('create_account'.tr, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: accentColor)),
                        const SizedBox(height: 24),
                        _buildField('username'.tr, Icons.person_outline, (v) => controller.username.value = v, textColor: textColor, hintColor: hintColor, fillColor: fillColor, borderColor: borderColor, accentColor: accentColor),
                        const SizedBox(height: 14),
                        _buildField('email_optional'.tr, Icons.email_outlined, (v) => controller.email.value = v, textColor: textColor, hintColor: hintColor, fillColor: fillColor, borderColor: borderColor, accentColor: accentColor, keyboard: TextInputType.emailAddress),
                        const SizedBox(height: 14),
                        _buildField('password'.tr, Icons.lock_outline, (v) => controller.password.value = v, textColor: textColor, hintColor: hintColor, fillColor: fillColor, borderColor: borderColor, accentColor: accentColor, obscure: true),
                        const SizedBox(height: 14),
                        _buildField('confirm_password'.tr, Icons.lock_outline, (v) => controller.confirmPassword.value = v, textColor: textColor, hintColor: hintColor, fillColor: fillColor, borderColor: borderColor, accentColor: accentColor, obscure: true),
                        const SizedBox(height: 24),
                        SizedBox(
                          height: 48,
                          child: ElevatedButton(
                            ...
                            child: controller.isLoading.value
                                ...
                                : Text('register'.tr, style: const TextStyle(fontSize: 16, color: Colors.white)),
                          ),
                        ),
                        const SizedBox(height: 16),
                        TextButton(
                          onPressed: controller.goToLogin,
                          child: Text('has_account_hint'.tr, style: TextStyle(color: accentColor)),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildField(String hint, IconData icon, Function(String) onChanged, {
    required Color textColor, required Color hintColor, required Color fillColor,
